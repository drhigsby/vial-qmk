...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_0] = LAYOUT(
        ...
        KC_LALT,        KC_LCTL, MO(_1),  KC_DEL,  KC_SPC,  MO(_2),  MO(_3)
    ),
    ...
    [_1] = LAYOUT(
        ...
        _______, _______, _______, KC_MUTE, _______, _______, _______
    ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_0] = { ENCODER_CCW_CW(KC_PGDN, KC_PGUP) },
    [_1] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [_2] = { ENCODER_CCW_CW(KC_PGDN, KC_PGUP) },
    [_3] = { ENCODER_CCW_CW(_______, _______) }
};
#endif
